        ...
        <div className="outline-grid">
          {stages.map((stage, idx) => (
            <div key={idx} className={`outline-card ${stage.active ? 'active' : ''}`}>
              ...
              {stage.active ? (
                <Link to={stage.link} className="card-link">
                  进入学习 &rarr;
                </Link>
              ) : (
